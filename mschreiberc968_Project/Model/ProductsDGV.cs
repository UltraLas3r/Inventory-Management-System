...
namespace mschreiberc968_Project.Model
{
    ...
    //    public string PRODUCT_NAME { get { return name; } }
    //    public string PRODUCT_INVENTORY { get { return Inventory.ToString(); } }
    //    public double PRODUCT_PRICE { get { return Price; } }
    ...
    //           static ProductsDGV() => ProductsProperty.Add( 
    //            new ProductsDGV { IdCode = 1, name = "Red Bike" };
    //    }
